...
class FilesGenerator:
    ...
    @staticmethod
    def add_secrets_to_configuration(
        config: dict[str, Any], config_fields: dict[str, FieldInfo]
    ):
        ...
        config_fields : dict[str, FieldInfo]
            Mapping of field names from the module's Model to their
            corresponding Pydantic ``FieldInfo`` definitions.
        """
