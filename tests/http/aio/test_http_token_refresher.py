...
class CustomTokenRefresher(GenericTokenRefresher):
    """
    Test implementation of GenericTokenRefresher that can be used in OAuth.
...
async def test_token_refresher_1(session_faker):
    ...
    token_refresher = await CustomTokenRefresher.instance(
        client_id,
        client_secret,
        auth_url,
    )

    assert token_refresher == await CustomTokenRefresher.instance(
        client_id,
        client_secret,
        auth_url,
    )
